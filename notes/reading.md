## Reading Notes (running)

*The third companion layer. **Manuscript Notes** track where the ancient witnesses disagree; **Translation Notes** track our own rendering choices; these — **Reading Notes** — are reader-facing: interpretive footnotes that illuminate the meaning or structure of a passage for someone reading the finished text. Format: chapter · title · the note.*
...
- **母, the Mother** (1, 20, 25, 52, 59) — the source that bears the ten-thousand things, that the sage nurses from (食母, 20), and that one returns to and holds fast (復守其母, 52). *See her own entry.*
- **玄牝, the mysterious female** (6) — the cosmic womb: "the valley spirit never dies; this is the mysterious female. Her gate is the root of heaven and earth." Chapter 6 is the thread's densest knot, binding *valley* + *spirit* + *female* + *gate* + *root* in six lines.
- **雌, the female** (10, 28) — the receptive role the sage is told to *keep to*: "know the male, but hold to the female, and be the valley of the world" (28) — which then flows straight on to the *infant* (嬰兒) and the *uncarved block* (樸).
