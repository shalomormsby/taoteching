## Translation Notes (running)

*Companion to the Manuscript Notes. Where those log textual forks between the witnesses, these log our own **rendering decisions** — the places where we deliberately depart from the most literal English for reasons of meaning, ethos, or clarity, and want the reasoning on record so a future reader (or a future us) can see it was a choice, not an accident. Format: chapter · the phrase · the choice · why. (This layer also holds a few **standing principles** — gathered here at the top — that govern rendering across every chapter.)*

---

### Standing principle · Lineation and punctuation — "the marks are yours; the music isn't"
...
**Strain cases, left unsettled rather than forced:** 天門 (10) — may be the gates of the senses, not the sky; 天將救之 (67) — reads agentive; 天子 (62) — kept as the institutional title *Son of Heaven*, the way one keeps "Pope."
...
**Ch 48 · 取天下 → "the world comes to you" (not "win" or "take the world").**
...
**Ch 52 · 其母 / 天下母 → "our Mother" (not "the Mother").**
...
**Ch 53 · 是謂 → "This exposes…" (not "This is called…").**
...
**Ch 55 · 全作 → "its whole being quickens with life" (setting aside the traditional male-erection gloss).**
