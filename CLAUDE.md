...
- **柔 → soft, 剛 → hard** — implied by the 弱 lock's four-word table, applied at ch 76 and now at ch 78, which is the line that forces it (弱之勝強，柔之勝剛). **Ch 52's 守柔曰強 is swept — it now reads *"To stay with the soft is strength"* (2026-08-26).** 柔 is `covers:`-ed by `glossary/ruo-弱.md`; 剛 is still owed its own mention.
